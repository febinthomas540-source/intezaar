...
<html lang="en">
      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#fffaf2;border:1px solid #dfcfba;border-radius:20px;overflow:hidden;">
          ...
          <tr><td style="padding:38px 30px;">
            ...
            <p style="margin:22px 0;color:#6d5143;font-size:17px;line-height:1.65;">The moment chosen for your private letter is here. Open the same private delivery and, if requested, complete recipient verification before the letter is released.</p>
            <a href="${recipientUrl}" style="display:inline-block;padding:15px 24px;border-radius:999px;background:#8f281f;color:#fff8ef;text-decoration:none;font-weight:700;">Open your letter</a>
            <p style="margin:24px 0 0;color:#8a7162;font-size:13px;line-height:1.55;">Keep this private link to yourself. Intezaar never asks you to forward a verification code.</p>
          </td></tr>
  ...
  try {
    ...
    return {
      ...
      recipient: input.to,
      emailId: result.id,
      message: `Arrival notification scheduled for ${input.to}.`,
    };
  } catch (error) {
